...
```{r Figure 1}
#Import
Facility_A_new_sig_prcc <- read.csv('Facility_A_wk8_Sensitivity_Matrix.csv')
Facility_B_new_sig_prcc <- read.csv('Facility_B_wk8_Sensitivity_Matrix.csv')
#Plot
Facility_A_data_matrix <- matrix(c(Facility_A_new_sig_prcc$PRCC), ncol=length(Facility_A_new_sig_prcc$PRCC))
colnames(Facility_A_data_matrix) <- rownames(Facility_A_new_sig_prcc)
#ggplot of significant
Facility_A_data_matrix_melted <- reshape2::melt(Facility_A_data_matrix)[2:3]
Facility_A_data_matrix_melted <- transform(Facility_A_data_matrix_melted, variable=reorder(Var2, value))
Facility_A_data_matrix_melted <- cbind(Facility_A_data_matrix_melted,Facility_A_new_sig_prcc$p.Value)
colnames(Facility_A_data_matrix_melted) <- c("Var2","value","variable","p_value")
...
Facility_B_data_matrix <- matrix(c(Facility_B_new_sig_prcc$PRCC), ncol=length(Facility_B_new_sig_prcc$PRCC))
colnames(Facility_B_data_matrix) <- rownames(Facility_B_new_sig_prcc)
#ggplot of significant
Facility_B_data_matrix_melted <- reshape2::melt(Facility_B_data_matrix)[2:3]
Facility_B_data_matrix_melted <- transform(Facility_B_data_matrix_melted, variable=reorder(Var2, value))
Facility_B_data_matrix_melted <- cbind(Facility_B_data_matrix_melted,Facility_B_new_sig_prcc$p.Value)
colnames(Facility_B_data_matrix_melted) <- c("Var2","value","variable","p_value")
...
ggsave("Figure_1.tif", plot = figure_1, width = 19.05, height = 22.23*1, units = "cm", device = "tiff", dpi = 600, compression = "lzw")
figure_1
```
...
ggsave("Figure_3.tif", plot = figure_3, device = "tiff",  width = 19.05, height = 22.23*0.8, units = "cm", dpi = 600, compression = "lzw")
figure_3
```
...
ggsave("Figure_5.tif", plot = figure_5, width = 19.05, height = 22.23*1, units = "cm", device = "tiff", dpi = 600, compression = "lzw")
figure_5
```
...
ggsave("Figure_6.tif", plot = figure_6, width = 25, height = 27*1, units = "cm", device = "tiff", dpi = 600, compression = "lzw")
figure_6
```
...
ggsave("Figure_7.tif", plot = figure_7, width = 19.05, height = 22.23*1, units = "cm", device = "tiff", dpi = 600, compression = "lzw")
figure_7
```
...
ggsave("Figure_8.tif", plot = figure_8, width = 25, height = 27*1, units = "cm", device = "tiff", dpi = 600, compression = "lzw")
figure_8
```
...
#Unused
#Import
Facility_A_durations_supplemental <- read.csv('Facility_A_Durations_Supplemental.csv')
Facility_A_durations_supplemental$scenario <- as.factor(Facility_A_durations_supplemental$scenario)
Facility_A_durations_supplemental$type <- factor(Facility_A_durations_supplemental$type, levels = c("Transient (Short)","Transient (Long)","Transient (Uncleanable)","Persistent (Short)","Persistent (Long)","Persistent (Uncleanable)"))

Facility_B_durations_supplemental <- read.csv('Facility_B_Durations_Supplemental.csv')
Facility_B_durations_supplemental$scenario <- as.factor(Facility_B_durations_supplemental$scenario)
Facility_B_durations_supplemental$type <- factor(Facility_B_durations_supplemental$type, levels = c("Transient (Short)","Transient (Long)","Transient (Uncleanable)","Persistent (Short)","Persistent (Long)","Persistent (Uncleanable)"))
#Plot
#Plot
figure_a <- ggplot() +
  geom_boxplot_pattern(
    data = Facility_A_durations_supplemental,
    mapping = aes(
            x = type,
            y = duration,
            pattern = scenario,
...
figure_b <- ggplot() +
  geom_boxplot_pattern(
    data = Facility_B_durations_supplemental,
    mapping = aes(
            x = type,
            y = duration,
            pattern = scenario,
...
ggsave("Figure_S8.tif", plot = figure_S8, width = 19.05, height = 22.23*1, units = "cm", device = "tiff", dpi = 600, compression = "lzw")
figure_S8
```
